...
public class Vehiculo_gasolina extends Vehiculo{
     ...
     */
    public Vehiculo_gasolina(String placa, String marca, Estado_vehiculo estadoVehiculo, int modelo, int cantidadCambios, double velocidadMax, double cilindraje, Tipo_transmision tipoTransmision, Tipo_uso tipoUso) {
